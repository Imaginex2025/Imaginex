...
const steps = [
  {
    ...
    description:
      "Explore the application of Gen AI in transforming industries through automation, content generation, and personalized experiences.",
  },
  {
    title: "Full-Stack Development Mastery",
    description:
      "Delve into both frontend and backend technologies, frameworks, and best practices for building scalable applications.",
  },
  {
    title: "Cloud-Native Architecture",
    description:
      "Understand cloud deployment models, serverless computing, and DevOps tools to build resilient, distributed systems.",
  },
  {
    title: "Big Data & Analytics",
    description:
      "Harness the power of data lakes, real-time processing, and machine learning pipelines to drive informed decisions.",
  },
  {
    title: "Edge & Emerging Technologies",
    description:
      "Stay ahead with trends in edge computing, quantum computing, and blockchain for next-gen digital solutions.",
  },
  {
    title: "Innovation Strategy & Trends",
    description:
      "Align technology adoption with strategic business goals by leveraging trend forecasting and competitive intelligence.",
  },
];

export const Service4: React.FC = () => {
